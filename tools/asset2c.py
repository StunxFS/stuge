...
for asset in ASSETS:
    with open(asset, "rb") as f:
        ...
        print(
            f"[asset2c] generating header for '{asset}' (result: 'src/data/{final_name}.h')"
        )
        with open(os.path.join("src", "data", final_name + ".h"), "w") as fn:
            ...
            fn.write(f"#ifndef {final_name_upper}_H\n")
            fn.write(f"#define {final_name_upper}_H\n\n")
            ...
            fn.write("};\n\n")
            fn.write(f"#endif // {final_name_upper}_H\n")
